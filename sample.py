...
#scatter.ax_plot(ax, df1['date'].to_list(), df1['value'].to_list(), "a")
#scatter.ax_plot(ax, df2['date'].to_list(), df2['value'].to_list(), "b")

scatter.df_plot(df1, ax, 'date', 'value', "a")
scatter.df_plot(df2, ax, 'date', 'value', "b")
